package com.jdd.streaming.demo.connectors.source;
...
import com.jdd.streaming.demo.connectors.common.RocketMQUtils;
...
import static com.jdd.streaming.demo.connectors.common.RocketMQConfig.*;
import static com.jdd.streaming.demo.connectors.common.RocketMQUtils.getInteger;
import static com.jdd.streaming.demo.connectors.common.RocketMQUtils.getLong;
...
public class RocketMQSource<OUT> extends RichParallelSourceFunction<OUT>
    ...
    private RocketMQUtils.RunningChecker runningChecker;
    ...
    public void open(Configuration parameters) throws Exception  {
        ...
        runningChecker = new RocketMQUtils.RunningChecker();
    ...
    public void run(SourceContext context) throws Exception {
        ...
        // 通过sleep 等到producer提供message 否则会导致pullscheduleservice.start后 无法处理后续到来的message
        awaitTermination();
